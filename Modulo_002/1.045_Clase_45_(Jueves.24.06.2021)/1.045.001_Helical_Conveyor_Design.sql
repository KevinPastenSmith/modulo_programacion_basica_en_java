...
CREATE TABLE `helice` (
  ...
  `sentidoHelice` varchar(45) DEFAULT NULL,
  `tipoHelice` varchar(45) DEFAULT NULL,
  `pasoHelice` varchar(45) DEFAULT NULL,
...
CREATE TABLE `material` (
  ...
  `tipoMezcla` varchar(45) DEFAULT NULL,
  `clasificacion` varchar(45) DEFAULT NULL,
  `tipoMaterial` varchar(45) DEFAULT NULL,
  `abrasividad` varchar(45) DEFAULT NULL,
  `densidad` double DEFAULT NULL,
  `fluidez` varchar(45) DEFAULT NULL,
  `categoriaPeso` varchar(45) DEFAULT NULL,
...
CREATE TABLE `transportador` (
  ...
  `nombreTransportador` varchar(45) DEFAULT NULL,
...
CREATE TABLE `usuario` (
  ...
  `profesionOficio` varchar(45) DEFAULT NULL,
...
/*!50001 VIEW `v_conveyor_parameters` AS select `transportador`.`nombreTransportador` AS `nombreTransportador`,`transportador`.`fechaDiseño` AS `fechaDiseño`,`tubo`.`diametroNominalTubo` AS `diametroNominalTubo`,`transportador`.`velocidadTransporte` AS `velocidadTransporte`,`transportador`.`areaRelleno` AS `areaRelleno`,`transportador`.`inclinacion` AS `inclinacion`,`transportador`.`capacidadTransportador` AS `capacidadTransportador`,`helice`.`velocidadGiro` AS `velocidadGiro`,`helice`.`sentidoGiro` AS `sentidoGiro` from ((`transportador` join `helice`) join `tubo`) */;
...
-- Dump completed on 2021-06-25 18:08:58
